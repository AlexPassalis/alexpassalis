...
import { errorInvalidEmail, errorInvalidUsername } from '@/data/zod/error'
        ...
        {signInEmail ? (
          <>
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Insert your email and username <br /> to create your account
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form
                onSubmit={async e => {
                  ...
                  const { data: usernameValidated } =
                    typeUsername.safeParse(usernameSubmitted)
                  if (!usernameValidated) {
                    console.error(errorInvalidUsername)
                    return
                  }
